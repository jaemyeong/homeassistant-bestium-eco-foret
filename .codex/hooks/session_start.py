...
- Delegate product code only to project-local product_implementer using exact gpt-5.6-luna with reasoning effort max; no fallback. Obtain a read-only adversarial review.
