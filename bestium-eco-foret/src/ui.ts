...
.btn--quiet{background:none;border:1px solid var(--outline-color);min-height:40px}
...
.stepper__btn{display:flex;align-items:center;justify-content:center;width:40px;min-height:40px;
